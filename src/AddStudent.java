...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Contact Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Copperplate Gothic Light", 1, 18))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Technical Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Copperplate Gothic Light", 1, 18))); // NOI18N
        ...
        jLabel10.setText("Last attended School/College");

        jLabel11.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel11.setText("Aggregate");
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "sem1", "sem2", "sem3", "sem4", "sem5", "sem6", " " }));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rr/images/Add-a-male-user-1202095241.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rr/images/iSync.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rr/images/delete.png"))); // NOI18N
    ...
    String reg,fn,mn,ln,bdate,age,sex,roll,la,agg,mob,home,email,add1,add2,city,state,country,sem,pass;
    pass=jPasswordField1.getText();
    reg=jTextField6.getText();
    fn=jTextField1.getText();
    mn=jTextField2.getText();
    ln=jTextField3.getText();
    bdate=jComboBox2.getSelectedItem().toString()+"/"+jComboBox2.getSelectedItem().toString()+"/"+jTextField17.getText();
    age=jTextField5.getText();
    sex=jComboBox1.getSelectedItem().toString();
    sem=jComboBox4.getSelectedItem().toString();
    roll=jTextField7.getText();
    la=jTextField9.getText();
    agg=jTextField10.getText();
    mob=jTextField11.getText();
    home=jTextField12.getText();
    ...
    String quer="INSERT into std_prof(reg_no,fn,mn,ln,date,sex,roll_no,last_school,aggregate,"
            + "mob,home,email,city,state,country,add1,add2,age,sem,pass) VALUES('"+reg+"','"+fn+"','"+mn+"','"+ln+"','"+bdate+"','"+sex+"',"
            + "'"+roll+"','"+la+"','"+agg+"','"+mob+"','"+home+"','"+email+"','"+city+"','"+state+"','"+country+"','"+add1+"',"
            + "'"+add2+"','"+age+"','"+sem+"','"+pass+"')";
    String quer2="SELECT reg_no FROM std_prof WHERE reg_no='"+reg+"'";
    if(reg.length()>0&&fn.length()>0&&roll.length()>0&&ln.length()>0&&la.length()>0&&city.length()>0&&email.length()>0)
            {
                DatabaseConnect db=new DatabaseConnect("cs");           
        try {
            rs=db.exeQuerry(quer2);
            if(rs.next()==false)
            {
            ...
            {
                JOptionPane.showMessageDialog(null,"Register Number already exist..!","",JOptionPane.ERROR_MESSAGE);
            }
         } catch (Exception ex) {
