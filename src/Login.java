...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "HOD", "Faculty" }));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rr/images/116990-matte-blue-and-white-square-icon-business-key7.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(type.equalsIgnoreCase("Faculty"))
        {
            ...
            if(flag1==0 && flag2==0)
            {
                ...
                rs=db.exeQuerry("SELECT user_id,password from faculty_login WHERE user_id='"+uname+"'");
                while(rs.next())
                {
                    str1 = rs.getString("user_id");
                ...
                if(str1.equals(uname))
                {
                    if(str2.equals(pass))
                    {
                        ...
                        Faculty f=new Faculty(dept,uname);
                        lastlogin=date.toString();
                        db.exe("UPDATE faculty_login SET last_seen='"+lastlogin+"' WHERE user_id='"+uname+"'");
                        f.setVisible(true);
            ...
            {
        JOptionPane.showMessageDialog(null,"Please Enter faculty username and password","",JOptionPane.WARNING_MESSAGE);}
        }
        else
        {
            String uname;
            ...
            try
            {
                uname=jTextField1.getText().toString();
                pass=jPasswordField1.getText().toString();
                rs=db.exeQuerry("SELECT user_id,password from hod_login WHERE user_id='"+uname+"'");
                while(rs.next())
                {
                    str1 = rs.getString("user_id");
                    str2= rs.getString("password");
            ...
            {
                JOptionPane.showMessageDialog(null,"Please Enter username and password","",JOptionPane.WARNING_MESSAGE);
            }
