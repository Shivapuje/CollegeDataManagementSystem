...
public class ListAllHod extends javax.swing.JFrame {
    ResultSet rs;
    ...
    public final void show_table()
    {
       DatabaseConnect db=new DatabaseConnect("management");
        ...
        String quer="SELECT user as USER_ID,Name as NAME,lname as LNAME,con1 as CONTACT,email as EMAIL,joindate as JOINDATE,pic as PHOTO, dept as HOD_OF from hod_prof";
        try {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "Name", "Department", "Contact", "Email"
            }
        ) {
        ...
        jLabel1.setText("List of all HOD's with Respect thier Department");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListAllHod().setVisible(true);
            }
        });
    }
