...
public class ListAllFaculty extends javax.swing.JFrame {
    ResultSet rs;
    String database;
    public ListAllFaculty(String d) {
        initComponents();
        database=d;
        show_table();
    }
    public final void show_table()
    {
       DatabaseConnect db=new DatabaseConnect(database);
        ...
        String quer="SELECT user as USER_ID,Name as NAME,lname as LNAME,con1 as CONTACT,email as EMAIL,joindate as JOINDATE from faculty_prof";
        try {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "USER_ID", "NAME", "LAST NAME", "CONTACT", "EMAIL", "JOINDATE"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListAllFaculty("management").setVisible(true);
            }
        });
    }
